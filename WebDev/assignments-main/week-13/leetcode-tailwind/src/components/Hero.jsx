  ...
  return (
    <>
      <section className="grid lg:grid-cols-12  gap-10  my-15 mx-10  w-full">
        <div className=" bg-[#262626] h-96 min-h-110 mx-5 max-w-150 p-5 translate-y-4 min-w-50   lg:col-span-4 rounded-lg shadow-lg overflow-hidden">
        ...
        <div className=" mx-5   lg:col-span-8 min-h-96 p-4    rounded-lg shadow-lg">
          <div className="flex mb-5 items-center gap-2.5 ">
